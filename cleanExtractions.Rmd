...
# all with any score
scores_tracking <- query("SELECt PMID, Title, Authors, Year, extractor, test_performance_status,
                test_type, score FROM trackingfile WHERE include_ = 'yes' AND test_performance = 'yes' 
                AND test_type LIKE '%score%' ORDER by extractor, test_performance_status")
